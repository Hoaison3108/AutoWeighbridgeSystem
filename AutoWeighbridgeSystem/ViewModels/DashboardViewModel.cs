...
namespace AutoWeighbridgeSystem.ViewModels
{
    public partial class DashboardViewModel : ObservableObject, IDisposable
    {
        ...
        [ObservableProperty] private string _stationName = "KHOÁNG SẢN RẠNG ĐÔNG - ĐIỀU HÀNH TRẠM CÂN";
        ...
        [ObservableProperty] private bool _isRfidScanning = false;
            ...
            Func<string, QuickVehicleRegisterViewModel> quickRegisterVmFactory)
        {
            ...
            _coordinator.RfidScanningStateChanged += OnRfidScanningStateChanged;
        ...
        private void OnRfidScanningStateChanged(bool isScanning)
        {
            IsRfidScanning = isScanning;
        }
